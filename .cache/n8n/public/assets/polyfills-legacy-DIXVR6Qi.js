(function() {
	...
	var structuredCloneInternal = function(value, map) {
		...
		switch (type) {
			case "Array":
				cloned = Array$1(lengthOfArrayLike$3(value));
				break;
			case "Object":
				cloned = {};
				break;
			...
			case "FileList":
				...
				if (dataTransfer) {
					for (i = 0, length = lengthOfArrayLike$3(value); i < length; i++) dataTransfer.items.add(structuredCloneInternal(value[i], map));
		...
		switch (type) {
			...
			case "Object":
				...
				for (i = 0, length = lengthOfArrayLike$3(keys$2); i < length; i++) {
					key$1 = keys$2[i];
	...
	var tryToTransfer = function(rawTransfer, map) {
		...
		iterate$1(rawTransfer, function(value$1) {
			push$4(transfer, anObject$2(value$1));
		});
		var i = 0;
		var length = lengthOfArrayLike$3(transfer);
